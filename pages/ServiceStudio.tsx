      ...
      <div className="container  mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16">
        ...
        <div className="space-y-12">
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2 aspect-[3/1] w-full overflow-hidden border-b border-border bg-gray-100 relative rounded-t-lg">
            ...
            {siteImages.services.studioGallery.slice(1, 3).map((img, i) => (
              <div key={i} className="aspect-[3/2] w-full overflow-hidden border-b border-border bg-gray-100 relative rounded-t-lg">
