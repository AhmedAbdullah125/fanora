    ...
    <div className="pt-20">
      ...
      <div className="bg-light-bg py-20 px-6">
        <div className="container  mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="aspect-[3/2] w-full overflow-hidden border-b border-border bg-gray-100 relative rounded-lg">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {siteImages.services.marketingGallery.map((img, idx) => (
                <div key={idx} className="aspect-[3/2] w-full overflow-hidden border-b border-border bg-gray-100 relative rounded-lg">
